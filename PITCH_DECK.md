...
* **Kwame / Fatima (12–16 yrs) · The Low-Connectivity Learner**
  * *Pain Point:* Expensive mobile data, low-end Android Go smartphone.
  * *Goal:* Ace BECE/WAEC exams using zero data via offline caching.
...
* **Premium Student**
  ...
  * *Includes:* Unlimited lessons, offline mode, speed drills, and weekly parent reports.
* **School Licensing**
...
*Scaling Global Mathematics Literacy via Carrier Integrations*
...
*Contact:* `investors@mathchines.com` · *Website:* `mathchines.com/pitch-investor`

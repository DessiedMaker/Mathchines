...
def add_mermaid_diagram(doc, mermaid_code):
    try:
        ...
        temp_img_path = "temp_mermaid_roadmap.png"
...
def build_document():
    ...
    title_run = title_p.add_run("Project Roadmap 2026: Mathchines")
    title_run.font.name = 'Calibri Light'
    title_run.font.size = Pt(26)
    title_run.font.bold = True
    title_run.font.color.rgb = RGBColor(0x2E, 0x5B, 0x88) # Blue color
    ...
    skip_heading_1 = True # We skip the very first Heading 1 since it's the title we custom-added
    in_mermaid = False
    mermaid_lines = []
    ...
    for i, line in enumerate(lines):
        ...
        if clean_line.startswith('|') and clean_line.endswith('|'):
            ...
            for idx, text in enumerate(table_headers):
                ...
                set_cell_background(hdr_cells[idx], "2E5B88") # Blue header
    ...
    output_filename = "PROJECT_ROADMAP.docx"
    try:
        doc.save(output_filename)
        print(f"Successfully generated {output_filename}!")
    except PermissionError:
        output_filename = "PROJECT_ROADMAP_UPDATED.docx"
        doc.save(output_filename)
        print(f"Primary file locked. Successfully generated alternative: {output_filename}!")

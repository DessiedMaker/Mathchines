          ...
          <div className="grid gap-6 md:grid-cols-2 items-center animate-fade-in">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-slate-100 font-display">
                Unlocking the Frictionless Path
              </h3>
              ...
              {[
                {
                  ...
                  desc: "Pay GHS 1-2 per day via phone airtime. No credit card required.",
                  icon: Coins,
                  color: "text-emerald-400 bg-emerald-500/10",
                },
                {
                  title: "Zero-Rated Data",
                  desc: "Zero data costs for subscribers via telecom partner proxy agreements.",
                  icon: Globe2,
                  color: "text-teal-400 bg-teal-500/10",
                },
                {
                  title: "Offline-First Engine",
                  desc: "Entire syllabus sets downloaded in seconds. Playable offline.",
                  icon: WifiOff,
                  color: "text-sky-400 bg-sky-500/10",
                },
                {
                  title: "Syllabus Mapper",
                  desc: "Adapts automatically to GES, WAEC, CCSS, and national curricula.",
                  icon: Brain,
          ...
          <div className="grid gap-6 md:grid-cols-2 items-center animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed font-sans">
                Our initial target markets address high-growth remedial segments in the US
                (under-resourced schools) and standard primary/secondary segments in Sub-Saharan
                Africa (where parents prioritize tutoring spend above all else).
              </p>
            ...
            <div className="relative aspect-[4/3] flex items-center justify-center p-4 border border-slate-800 bg-slate-950/30 rounded-2xl">
              <div className="w-full max-w-[280px] aspect-square rounded-full border border-slate-800 bg-slate-900/10 flex items-center justify-center relative p-6">
                <span className="absolute top-4 text-[9px] font-mono text-slate-500 uppercase tracking-widest font-bold">
                  TAM: $400 Billion
                </span>
                ...
                <div className="w-4/5 aspect-square rounded-full border border-teal-800 bg-teal-950/10 flex items-center justify-center relative p-6">
                  <span className="absolute top-4 text-[9px] font-mono text-teal-500 uppercase tracking-widest font-bold">
                    SAM: $45 Billion
                  </span>
                  ...
                  <div className="w-2/3 aspect-square rounded-full border border-emerald-500/40 bg-emerald-950/40 flex flex-col items-center justify-center text-center relative p-2 shadow-lg shadow-emerald-950/35">
                    <span className="text-[8px] font-mono text-emerald-400 uppercase tracking-widest font-bold mb-1">
                      SOM
                    </span>
        ...
        return (
          <div className="grid gap-6 md:grid-cols-3 animate-fade-in items-center">
            <div className="flex flex-col justify-center space-y-3">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                By aligning subscriber wallets with localized pricing, we ensure low churn. Airtime
                integration allows families to subscribe day-by-day based on current budget
                liquidity.
              </p>
            ...
            <div className="md:col-span-2 grid grid-cols-2 gap-4">
              <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-5 space-y-3 hover:border-slate-700 transition-all">
                ...
                <ul className="text-[10px] text-slate-400 space-y-1.5 border-t border-slate-800/80 pt-3">
                  ...
                  <li className="flex items-center gap-1.5">
                    <Check className="h-3 w-3 text-emerald-400" /> Free cellular data (Zero-rated)
                  </li>
                  <li className="flex items-center gap-1.5">
                    <Check className="h-3 w-3 text-emerald-400" /> Offline access to school syllabi
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-950/60 p-5 space-y-3 hover:border-slate-700 transition-all">
                ...
                <ul className="text-[10px] text-slate-400 space-y-1.5 border-t border-slate-800/80 pt-3">
                  <li className="flex items-center gap-1.5">
                    <Check className="h-3 w-3 text-sky-400" /> Standard web/app credit card billing
                  </li>
                  <li className="flex items-center gap-1.5">
                    <Check className="h-3 w-3 text-sky-400" /> AI personalized tutor modules
                  </li>
                  <li className="flex items-center gap-1.5">
                    <Check className="h-3 w-3 text-sky-400" /> Weekly parent analytics report
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="grid gap-6 lg:grid-cols-5 items-center animate-fade-in">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <p className="text-[10px] text-slate-400 leading-normal">
                Drag the levers below to model Mathchines' subscriber conversions, pricing ARPU, and
                valuation potential.
              </p>
      ...
      case 5:
        return (
          <div className="grid gap-6 md:grid-cols-2 items-center animate-fade-in">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-slate-100 font-display">
                Telecom & Growth Moats
              </h3>
              <p className="text-xs text-slate-400 leading-relaxed font-sans">
                Our primary acquisition engine relies on direct integration agreements with leading
                national carriers. Zero-rating removes user friction while carrier billing shares
                standard merchant revenue margins in exchange for bulk user placement.
              </p>
            ...
            <div className="space-y-3 p-4 border border-slate-800 bg-slate-950/40 rounded-2xl">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center block mb-2">
                Carrier Distribution Loop
              </span>
              {[
                {
                  step: "01. Telco API Hook",
                  label: "MTN, Telecel integration yields instant billing token",
                  pct: "100%",
                  width: "w-full",
                  bg: "bg-emerald-500",
                },
        ...
        return (
          <div className="grid gap-6 md:grid-cols-2 items-center animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed font-sans">
                Mathchines is engineered to survive low bandwidth. By separating the static
                curriculum schema from the adaptive client evaluation, we can package full courses
                into tiny index files.
              </p>
            ...
            <div className="space-y-3">
              {[
                {
                  title: "Curriculum Compiler",
                  desc: "AI maps raw PDF syllabi directly into structured adaptive trees matching national exams (GES, WAEC).",
                },
                {
                  title: "Lightweight Client (PWA)",
                  desc: "Optimized for Android Go & low RAM devices. Total initial assets bundle is less than 3.5MB.",
                },
                {
                  title: "Supabase Delta Sync",
                  desc: "Saves client telemetry locally, syncing using compressed delta patches when connectivity restores.",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
        ...
        return (
          <div className="grid gap-6 md:grid-cols-2 items-center animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed font-sans">
                We are raising $1.5M Seed Capital to complete integrations, expand national standard
                mappings, and build carrier billing pipelines.
              </p>
            ...
            <div className="space-y-4 p-5 border border-slate-800 bg-slate-950/40 rounded-2xl">
              ...
              {[
                {
                  label: "Product Engineering (Offline sync, Teacher dashboards)",
                  pct: "45%",
                  val: "$675k",
                  bar: "w-[45%]",
                ...
                {
                  label: "Telecom partnerships & Direct API integration",
                  pct: "30%",
                  val: "$450k",
                  bar: "w-[30%]",
                  color: "bg-teal-500",
                ...
                {
                  label: "Curriculum Maps & local expansion (NGA, KEN, UK)",
                  pct: "25%",
                  val: "$375k",
                  bar: "w-[25%]",
                  color: "bg-sky-500",
                ...
                <div key={idx} className="space-y-1">
                  <div className="flex justify-between text-[10px] leading-tight">
                    ...
                    <span className="font-mono font-bold text-slate-100">
                      {item.pct} <span className="text-[8px] text-slate-500">({item.val})</span>
                    </span>
                  </div>
        ...
        return (
          <div className="text-center animate-fade-in space-y-6">
            ...
            <p className="mt-4 text-xs text-slate-300 max-w-xl mx-auto leading-relaxed">
              We are opening mathematical literacy to billions of minds globally by meeting students
              where they are — on budget phones, without data, and paying standard local
              micro-denominations.
            </p>
            ...
            <div className="w-full max-w-6xl py-4 animate-fade-in">
              <div className="text-center mb-8">
                ...
                <p className="text-xs text-slate-400 mt-2 max-w-md mx-auto">
                  Click on any slide to jump directly to it in full-screen slideshow mode. All
                  interactive simulation controls are active inside the previews.
                </p>
              </div>
